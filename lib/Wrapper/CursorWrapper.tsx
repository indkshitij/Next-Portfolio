...
const CursorWrapper = ({
  ...
  return (
    ...
    >
      ...
      {hovering && (
        <div
          className={`p-1.5 pointer-events-none fixed z-[9999]  rounded-full font-semibold shadow-lg  flex items-center gap-1 transform -translate-x-1/2 -translate-y-1/2 ${textSize} ${bgColor} ${textColor}`}
        ...
        >
          ...
          <span className="px-1 w-fit h-fit">{description}</span>
